...
const Checkout = () => {
  const [form, setForm] = useState({ name: "", email: "saik21080@gmail.com", address: "testing" })
    ...
    <div style={styles.container}>
      ...
      {orderComplete ? (
        <div style={styles.successContainer}>
          ...
          <p style={styles.successText}>A confirmation email has been sent to {form.email}</p>
